...
\end{equation}
	...
	\begin{equation}
		...
		\frac{d N_i}{dy m_\perp dm_\perp d\phi_p} = \frac{g_i}{(2\pi)^3} \sum{n=1}^{\infty} (\pm)^n \int d^2 r_\perp \tau_f e^{n\mu_i/T} e^{n\gamma_\perp \vec{v_\perp} \cdot \vec{p_\perp}} x \int_{-\infty}^{+\infty} d\eta \left(m_\perp cosh(y-\eta) 
